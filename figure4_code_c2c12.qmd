...
cell_size_target <- 223.14 #pixels
...
params_results_c2c12 <- readRDS(file = here::here(
          "data", "r_objects", 
          paste0("params_results_c2c12", ".rds")))
...
summarized_c2c12 <- params_results_c2c12_annotated %>%
  ...
  #filter out the background wells
  filter( !well %in% c("A01",  "A12", "H01", "H12")) %>%
  summarize(
