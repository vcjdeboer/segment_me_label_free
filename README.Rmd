...
Open the shiny app in Rstudio, by opening the app.R file and click `Run App`. You can upload your image and follow the three steps as described in the figure below

![screenshot](shiny_example.png)
