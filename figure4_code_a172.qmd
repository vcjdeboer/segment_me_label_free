...
#a172 json file
sub_folder1 <- "nuclear_count_benchmark/"
json_file_path1 <- paste0("/Users/vincentdeboer/LIVEcell_dataset_2021/",
                          sub_folder1, "A172_counts.json")
...
a172_counts_fromjson <- a172_counts %>% 
  ...
  mutate(group = case_when(well %in% c("A8", "B8", "C8", "D8") ~ "2.5k",
...
path_names_a172 <- selected_a172 %>% 
    ...
    mutate(folder = case_when(substring(well, 2,2) == "8" ~ "2.5k",
                              substring(well, 2,2) == "7" ~ "5k",
                              substring(well, 2,2) == "6" ~ "10k",
                              .default = "nok")) %>% 
    mutate(path_name = 
      paste0("/Users/vincentdeboer/LIVECell_dataset_2021/nuclear_count_benchmark/A172/",
                 folder, "/", rowname))
...
paste0("number of iterations: ", total_iterations ,". Around ", total_iterations/400, " minutes to run")
